...
function AssistantComposer({
    ...
    const credits =
        mode === "image"
            ? imageCreditCost({ channelMode: config.channelMode, prices, mode: references.length ? "edit" : "generation", outputSize: outputSizeForImageQuality(config.quality), count: config.count })
