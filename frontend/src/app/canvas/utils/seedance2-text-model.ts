export type Seedance2PromptTextModelInput = {
  savedModel?: unknown;
  currentTextModel?: unknown;
  configuredTextModels?: readonly unknown[];
...
export function buildSeedance2PromptTextModelValues(
  input: Seedance2PromptTextModelInput,
  isTextModel: (model: string) => boolean,
) {
...
export function resolveSeedance2PromptTextModel(
  input: Seedance2PromptTextModelInput,
  isTextModel: (model: string) => boolean,
) {
