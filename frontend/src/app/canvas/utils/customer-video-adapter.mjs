import { SEEDANCE2_MAX_REFERENCE_SLOT_COUNT, getSeedance2FirstFrameReference } from './seedance2-reference-slots.mjs';
...
export function normalizeCustomerVideoRatio(value) {
  ...
  return SUPPORTED_CUSTOMER_VIDEO_RATIOS.includes(normalized) ? normalized : '9:16';
}
...
export function buildSeedance2CustomerVideoPayload(node, references = []) {
