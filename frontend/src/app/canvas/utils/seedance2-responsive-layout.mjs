import { SEEDANCE2_MAX_REFERENCE_SLOT_COUNT } from './seedance2-reference-slots.mjs';

export const SEEDANCE2_PORTRAIT_MIN_SIZE = { width: 420, height: 746 };
...
function fallbackRatio(value) {
  return value === '16:9' ? '16:9' : '9:16';
}

export function seedance2RatioFromNaturalSize(width, height, fallback = '9:16') {
...
export function seedance2SourceRatioFromNaturalSize(width, height) {
...
export function seedance2RatioFromNodeFrame(width, height, current = '9:16') {
...
export function seedance2VisibleReferenceSlotCount({ width, height, boundSlotCount = 0, isExpanded = false, orientation }) {
